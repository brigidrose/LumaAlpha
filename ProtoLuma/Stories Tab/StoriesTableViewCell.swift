...
import UIKit
import RACollectionViewReorderableTripletLayout
...
//        self.cardContainer.addSubview(self.storyHeroImageImageView)
        ...
        let cardContainerVerticalConstraintsStoryHeroImage = NSLayoutConstraint.constraintsWithVisualFormat("V:|[storyImagePreviewCollectionView(230)]-10-[storyTitleLabel]", options: NSLayoutFormatOptions(rawValue: 0), metrics: nil, views: cardContainerViewViewsDictionary)
