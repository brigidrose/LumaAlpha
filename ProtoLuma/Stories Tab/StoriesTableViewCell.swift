...
class StoriesTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        let cardContainerViewViewsDictionary = ["storyHeroImageImageView":self.storyHeroImageImageView, "storyTitleLabel":self.storyTitleLabel, "storySummaryLabel":self.storySummaryLabel]
        let cardContainerHorizontalConstraintsHeroImage = NSLayoutConstraint.constraintsWithVisualFormat("H:|[storyHeroImageImageView]|", options: NSLayoutFormatOptions(rawValue: 0), metrics: nil, views: cardContainerViewViewsDictionary)
        ...
        let cardContainerVerticalConstraintsStoryHeroImage = NSLayoutConstraint.constraintsWithVisualFormat("V:|[storyHeroImageImageView(190)]-10-[storyTitleLabel]", options: NSLayoutFormatOptions(rawValue: 0), metrics: nil, views: cardContainerViewViewsDictionary)
